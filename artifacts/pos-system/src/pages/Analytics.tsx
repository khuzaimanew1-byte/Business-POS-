...
function TopProductsBar({
  ...
  return (
    <div ref={containerRef} className="px-5 sm:px-6 pl-[15px] pr-[15px] pt-[10px] pb-[10px]">
      ...
      <div className="flex items-stretch gap-0">
        ...
        <div className="flex-1 min-w-0 relative">
          ...
          {/* Bars */}
          <div className="grid grid-cols-5 gap-2 sm:gap-8 items-end relative z-10">
            {slots.map((p, i) => {
                ...
                >
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {/* Bar container */}
                      <div
                        className="relative w-full flex items-end sm:px-[18%]"
